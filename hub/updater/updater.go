...
var (
	...
	baseURL       string = "https://github.com/MerlinKodo/clash-rev/releases/download/Prerelease-dev/clash.rev"
	versionURL    string = "https://github.com/MerlinKodo/clash-rev/releases/download/Prerelease-dev/version.txt"
	packageURL    string
...
func prepare(exePath string) (err error) {
	...
	if runtime.GOOS == "windows" {
		updateExeName = "clash.rev" + "-" + runtime.GOOS + "-" + runtime.GOARCH + amd64Compatible + ".exe"
	} else {
		updateExeName = "clash.rev" + "-" + runtime.GOOS + "-" + runtime.GOARCH + amd64Compatible
	}
